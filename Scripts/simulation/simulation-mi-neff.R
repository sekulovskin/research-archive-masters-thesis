...
Tau.B[1:2,1:2] ~ dwish(Sigma.B, 2)  # inverse of covariance matrix following a Wishard dist.
  ...
  Sigma.B[1,2] <- rho_1*sigma.alpha*sigma.beta_1 #covaroance between slope of b1 and intercept
...
mean_rsq0 <- mean(Mi_neff[1:50])
mean_rsq1 <- mean(Mi_neff[51:100])
mean_rsq2 <- mean(Mi_neff[101:150])
mean_rsq3 <- mean(Mi_neff[151:200])
...
avg_mi_neff <- data.frame(N_eff_0.4_1pred, N_eff_0.4_2pred, N_eff_3.2_1pred, N_eff_3.2_2pred)
avg_mi_neff$rsq <- c(0, 0.02, 0.13, 0.26)

rm(Mi_neff, N_eff_0.4_1pred, N_eff_0.4_2pred, N_eff_3.2_1pred, N_eff_3.2_2pred, mean_rsq0, mean_rsq1,
   mean_rsq2, mean_rsq3)
